...
$trip = $db->query("SELECT * FROM trip WHERE last_destination = 'y' LIMIT 4");
...
<body>
    ...
    <div class="sec-1">
        <div class="title" data-aos="fade-up">
            <h1>THE ULTIMATE <span>travel</span> FOR THOSE WHO <p>WANT</p> IT ALL</h1>
            <h3>
                Destinations, routes and advice for travelers
            </h3>
        </div>
    </div>
