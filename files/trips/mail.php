...
$text = 'You have a new reservation : Phone : ' . $phone . ' Email  : ' . $email . 'Trip    :' . $trip;
...
$succes = 'Your reservation has been successfully processed.<br>We sent a verification email to the address you submitted <br>We look forward to seeing you soon!
<br>';
