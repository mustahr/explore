    ...
    while ($row = $result->fetch_assoc()) { ?>
        ...
        <section class="sec_1" style=" background-image: url('data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['trip_front_image']); ?>');">
            ...
            <div class="container reserv_info" data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="back">
                    <a href="../category/category.php?id_cat=<?php echo $row['category'] ?>">
                        BACK TO CATEGORY
                    </a>
                </div>
            </div>
        ...
        <section class="sec_3">
            ...
            <div class="third" data-aos="fade-up">
                ...
                <div class="img">
                    ...
                    <p><?php echo $row['img_2_caption']; ?>r</p>
                </div>
        ...
        <section class="sec_5">
            ...
            <div class="map" data-aos="flip-up">
                <iframe src="<?php echo $row['trip_location']; ?>"></iframe>
            </div>
        </section>
        
        <div class="sec_6">
            <h1>⚠ Bear in mind that</h1>
            <h4>
